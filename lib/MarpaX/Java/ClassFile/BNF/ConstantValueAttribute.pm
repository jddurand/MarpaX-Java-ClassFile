...
#                          #
#                          my $constantvalue = $_[0]->getAndCheckCpInfo($constantvalue_index, undef, '_value');
#                          #
#                          # Only ConstantLongInfo, ConstantFloatInfo, ConstantDoubleInfo, ConstantIntegerInfo and ConstantStringInfo
#                          # have a _value method
#                          #
#                          $_[0]->tracef('Constant value: %s', "$constantvalue") # Explicit stringification
#                        }
                       }
              }
